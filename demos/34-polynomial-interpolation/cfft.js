// Source: https://rosettacode.org/wiki/Fast_Fourier_transform#JavaScript
...
function icfft(amplitudes) {
  ...
  for (var i = 0; i < N; ++i) if (amplitudes[i] instanceof Complex) amplitudes[i].im = -amplitudes[i].im;
