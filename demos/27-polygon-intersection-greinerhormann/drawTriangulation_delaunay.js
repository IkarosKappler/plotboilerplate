 ...
 * @param {boolean} drawDelaunayCircles
 * @return {Triangle[]}
 */

(function(context) {
    
    var drawTriangulation_delaunay = function( pb,
					       intersectionPolygon,
					       sourcePolygon,
					       clipPolygon,
					       drawDelaunayCircles
	...
	return filterNonNull(triangles);
    };

    var filterNonNull = function( arr ) {
	var filtered = [];
    ...
    context.drawTriangulation_delaunay = drawTriangulation_delaunay;
