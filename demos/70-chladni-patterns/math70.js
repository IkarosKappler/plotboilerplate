...
(function (_context) {
  ...
  _context.Math70.prototype.sin = function (box) {
    ...
    return function (x, _y) {
      ...
      var relY = ((_y - box.min.y) / box.height) * Math.PI * 2 + _self.config.verticalOffset * RAD2DEG;
      // Calculate function
  ...
  _context.Math70.prototype.sinVertical = function (box) {
    ...
    return function (_x, y) {
      // Map absolute to relative
      var relX = ((_x - box.min.x) / box.width) * Math.PI * 2 + _self.config.horizontalOffset * RAD2DEG;
