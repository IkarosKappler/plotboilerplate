  ...
  window.addEventListener("load", function () {
    ...
    var drawMorley = function () {
      ...
      var hexagon = new Polygon([
        trisectionA.sectorLines[1].intersection(trisectionB.sectorLines[2]),
    ...
    var trisectAngle = function (pA, pB, pC) {
      ...
      if (result.insideAngle < 0) result.insideAngle = 2 * Math.PI + result.insideAngle;
      if (!result.clockwise) result.insideAngle = (2 * Math.PI - result.insideAngle) * -1;
    ...
    var config = PlotBoilerplate.utils.safeMergeByKeys(
      {
        ...
        colors: {
          ...
          trisectors: ["#00a800", "#ff8800", "#0048ff"],
          hexagon: "#00a8ff",
          triangle: "#ff8800"
        }
      },
    ...
    // +-------------------------------
    {
      ...
      f0.addColor(config.colors.trisectors, 0)
        .onChange(function () {
          pb.redraw();
        })
        .name("Trisector A")
        .title("The first trisector");
      f0.addColor(config.colors.trisectors, 1)
        .onChange(function () {
          pb.redraw();
        })
        .name("Trisector B")
        .title("The second trisector");
      f0.addColor(config.colors.trisectors, 2)
        .onChange(function () {
          pb.redraw();
        })
        .name("Trisector C")
        .title("The third trisector");
      f0.addColor(config.colors, "hexagon")
        .onChange(function () {
          pb.redraw();
        })
        .name("Hexagon")
        .title("The hexagon color");
      f0.addColor(config.colors, "triangle")
        .onChange(function () {
          pb.redraw();
        })
        .name("Triangle")
        .title("The triangle color");
