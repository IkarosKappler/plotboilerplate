...
(function(_context) {
	...
	for( var i = 0; i < numCircles; i++ ) {
		...
		(function(c,rp,index) {
			c.center.listeners.addDragEndListener( function(e) { console.log(index, c.center)} );
			rp.listeners.addDragEndListener( function(e) { console.log(index, c.center, rp.distance(c.center))} );
