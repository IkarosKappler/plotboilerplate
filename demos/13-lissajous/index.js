...
(function(_context) {
	...
	function() {
	    ...
	    function getCorrectTextColor(tinyColor){
		...
		*/
		...
		hRed = tinyColor.r; // hexToR(hex);
		hGreen = tinyColor.g; // hexToG(hex);
		hBlue = tinyColor.b; hexToB(hex);
		...
		function drawCircles(staticFigure, figure, freqA, freqB, phaseA, phaseB, stepSize) {
		    ...
		    pb.draw.diamondHandle( hPos, 5, '#000000' );
