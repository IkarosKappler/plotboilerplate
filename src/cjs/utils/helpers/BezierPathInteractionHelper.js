...
var BezierPathInteractionHelper = /** @class */ (function () {
    ...
    function BezierPathInteractionHelper(pb, paths, options) {
        ...
        this.onVerticesDeleted =
            typeof options.onVerticesDeleted === "function"
                ...
                : function (i, r, n, o) { };
        this.onPathRemoved = typeof options.onPathRemoved === "function" ? options.onPathRemoved : function (i, o) { };
    ...
    BezierPathInteractionHelper.prototype.drawHandleLines = function () {
        ...
        this.paths.forEach(function (path) {
            path.bezierCurves.forEach(function (curve) {
                ...
                _this.pb.draw.line(curve.endPoint, curve.endControlPoint, "rgba(64,192,128,0.333)", 1.0, {
                    dashOffset: 0.0,
                    dashArray: [4, 2]
                });
            });
    ...
    BezierPathInteractionHelper.prototype._installTouchListener = function () {
        ...
        if (window["createAlloyFinger"]) {
            ...
            return new alloyfinger_typescript_1.default(this.pb.eventCatcher ? this.pb.eventCatcher : this.pb.eventCatcher, afProps);
        }
    };
    // +---------------------------------------------------------------------------------
    // | Called once upon initialization.
    ...
    BezierPathInteractionHelper.prototype._installMouseListener = function () {
        var _self = this;
        var mouseHandler = new MouseHandler_1.MouseHandler(this.pb.eventCatcher)
            .up(function (e) {
    ...
    BezierPathInteractionHelper.prototype._installKeyListener = function () {
        var _self = this;
        return new KeyHandler_1.KeyHandler({ trackAll: true }).down("delete", function () {
            _self._handleDelete();
        });
    };
    // +---------------------------------------------------------------------------------
