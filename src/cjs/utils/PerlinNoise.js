...
var PerlinNoise = /** @class */ (function () {
    ...
    // 2D simplex noise
    PerlinNoise.prototype.simplex2 = function (xin, yin) {
    ...
    // 3D simplex noise
    PerlinNoise.prototype.simplex3 = function (xin, yin, zin) {
    ...
    // 2D Perlin Noise
    PerlinNoise.prototype.perlin2 = function (x_init, y_init) {
    ...
    // 3D Perlin Noise
    PerlinNoise.prototype.perlin3 = function (x_init, y_init, z_init) {
        // Find unit grid cell containing point
