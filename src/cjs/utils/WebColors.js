...
exports.Red = Color_1.Color.Red; // Color.makeRGB(255,67,55);
exports.Pink = Color_1.Color.Pink; // Color.makeRGB(232,31,100);
exports.Purple = Color_1.Color.Purple; // Color.makeRGB(156,39,175);
exports.DeepPurple = Color_1.Color.DeepPink; // Color.makeRGB(103,59,184);
exports.Indigo = Color_1.Color.Indigo; // Color.makeRGB(64,81,181);
exports.Blue = Color_1.Color.Blue; // Color.makeRGB(35,151,245);
exports.LightBlue = Color_1.Color.LightBlue; // Color.makeRGB(6,170,245);
exports.Cyan = Color_1.Color.Cyan; // Color.makeRGB(3,189,214);
exports.Teal = Color_1.Color.Teal; // Color.makeRGB(1,150,137);
exports.Green = Color_1.Color.Green; // Color.makeRGB(77,175,82);
exports.LightGreen = Color_1.Color.LightGreen; // Color.makeRGB(141,195,67);
/**
