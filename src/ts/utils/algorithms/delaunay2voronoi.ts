...
export class delaunay2voronoi {
  ...
  // +-------------------------------
  private subsetToPath(triangleSet: Array<Triangle>, startPosition?: number, tryOnce?: boolean): Array<Triangle> {
    if (triangleSet.length == 0) return [];

    if (typeof startPosition === "undefined") startPosition = 0;
