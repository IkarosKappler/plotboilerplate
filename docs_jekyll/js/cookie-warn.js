(function (fn) {
  ...
  var warn = function () {
    ...
    var info =
      attributes.data.more_link && attributes.data.more_text
        ? ' <a target="_blank" href="' + attributes.data.more_link + '">' + attributes.data.more_text + "</a> "
        : "";
    var accept_button =
    ...
    if (attributes.data.reject_text) {
      ...
      if (attributes.data.reject_info || attributes.data.reject_link) {
        ...
        reject_content +=
          attributes.data.reject_info +
          ' <a target="_blank" href="' +
          attributes.data.reject_link +
          '">' +
          attributes.data.reject_link +
          "</a> ";
        reject_content +=
    ...
    wbox.innerHTML =
      '<div class="text">' + attributes.data.text + info + accept_button + reject_button + reject_content + "</div>";
